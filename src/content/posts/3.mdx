...
description: Deep dive into Tenstorrent's unique approach to AI hardware with their Network-on-Chip architecture and open-source software stack
audioPath: https://tts.apurva-mishra.com/tts_3.m4a
audioType: audio/mp4
---
import Image from '../../components/Image.astro'
import tenstorrent_logo from '../../assets/tenstorrent_logo.png';
import rdna4_audience from '../../assets/rdna4_audience.png';
import transformer from '../../assets/transformer.png';
import ar_llm from '../../assets/ar_llm.png';
import billy_data from '../../assets/billy_data.png';
import horace_factory from '../../assets/horace_factory.png';
import map_graph from '../../assets/map_graph.png';
import amd_intel from '../../assets/amd_intel.png';
import ascalon from '../../assets/ascalon.png';
...
<Image src={tenstorrent_logo} label="Notice lowercase t in the logo, uncommon but neat!" />
...
<Image src={rdna4_audience} label="RDNA4 Instruction Set Architecture, scaring away any js dev from getgo" />
...
Additionally, you should use [deepwiki](https://deepwiki.com/). I am probably responsible for half of the tenstorrent repos indexed over there 🤣. Try this method for [understanding their codebases](https://www.zhihu.com/question/1959981370546829039/answer/1963314554365796511).
...
<Image src={transformer} label="Transformer Architecture which enabled Will Smith eating spaghetti" />
...
<Image src={ar_llm} label="Autoregressive LLM" />
...
<Image src={billy_data} label="Bill Dally presenting 'Hardware for Deep Learning'" />
...
<Image src={horace_factory} label="Yoinked from https://horace.io/brrr_intro.html" />
...
<Image src={map_graph} label="Compute graph mapped on to tenstorrent chip" />
...
The truth of the matter is that Moore's Law in its purest sense has been dead for quite a while. Read this blog from Adi Fuchs: [AI Accelerators — Part II: Transistors and Pizza (or: Why Do We Need Accelerators)?](https://medium.com/@adi.fu7/ai-accelerators-part-ii-transistors-and-pizza-or-why-do-we-need-accelerators-75738642fdaa).

Neither is it a law. I would argue that it is a target and it is through effort of engineers that we keep matching it. The blog by Adi, explains various different scaling axis we have used and next innovation when one starts to fail. According to [The Relentless Pursuit of Moore's Law](https://semiconductor.substack.com/p/the-relentless-pursuit-of-moores-fcd), Apple's M2 chip is right on line of the moore's law. I [asked Kimi K2 about this](https://www.kimi.com/share/d3t8f8ktr22riijkvb4g), it pointed out that the metric used to measure this has been changed from CPU core(original Moore's Law) to System-on-Chip. I believe this is just another axis we are scaling on.

This brings me to perhaps my favourite slide by Jim Keller.

<Image src={amd_intel} label="Change w/ Jim Keller on Youtube" />
...
<Image src={ascalon} label="Beyond Innovation: RISC-V's Path to Mass Adoption with Mature IP by Wei-Han Lien | Tenstorrent" />
